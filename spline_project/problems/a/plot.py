...
def plot_curve(d, N, polynomials, filename = "plot.png"):
    ...
    if d == 1:
        ...
        # 额外绘制 y = 1/(1 + 25t^2) 的图像
        y_values = [1/(1 + 25*t**2) for t in t_values]
...
if __name__ == "__main__":
    filenames = ["polynomials_6.txt", "polynomials_11.txt", "polynomials_21.txt", "polynomials_41.txt", "polynomials_81.txt"]
